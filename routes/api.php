...
Route::namespace('Api')->group(function() {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::apiResource('admins', 'AdminController')->middleware('permission:' . Acl::PERMISSION_PERMISSION_MANAGE);
        Route::apiResource('managers', 'ManagerController')->middleware('permission:' . Acl::PERMISSION_PERMISSION_MANAGE);
        Route::apiResource('commercials', 'CommercialController')->middleware('permission:' . Acl::PERMISSION_PERMISSION_MANAGE);
        Route::apiResource('hosts', 'HostController')->middleware('permission:' . Acl::PERMISSION_PERMISSION_MANAGE);
        Route::apiResource('guests', 'GuestController')->middleware('permission:' . Acl::PERMISSION_PERMISSION_MANAGE);

        Route::apiResource('listings', 'ListingController');
        Route::apiResource('immobiliers', 'ImmobilierController');
